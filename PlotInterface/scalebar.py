...
def _setlength(ax, location):
    """
    If no length is given, then set an arbitrary length of the scale bar

    :param ax: `cartopy.mpl.geoaxes.GeoAxes` instance
