# -*- coding: utf-8 -*-
#
# TCRM documentation build configuration file, created by
...
html_short_title = "TCRM User Guide"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "docs/GA_0.gif"
